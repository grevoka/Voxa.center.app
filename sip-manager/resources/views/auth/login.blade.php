...
<head>
    ...
    <title>Connexion — Voxa Center</title>
...
<body>
    <div class="login-container">
        <div class="login-brand" style="text-align:center;">
            <img src="{{ asset('images/logo.png') . '?v=' . filemtime(public_path('images/logo.png')) }}" alt="Voxa Center" style="height:70px;object-fit:contain;">
