            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="description" class="form-control" value="{{ old('description') }}"
                           placeholder="Description courte du contexte">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <small style="color:var(--text-secondary);font-size:0.72rem;">Syntaxe Asterisk : _ pour debut pattern, X=0-9, Z=1-9, N=2-9, .=wildcard</small>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <select name="destination_type" class="form-select">
                        <option value="extensions" {{ old('destination_type') === 'extensions' ? 'selected' : '' }}>Extensions</option>
                        <option value="trunk" {{ old('destination_type') === 'trunk' ? 'selected' : '' }}>Trunk</option>
                        <option value="queue" {{ old('destination_type') === 'queue' ? 'selected' : '' }}>File d'attente</option>
                    ...
                    <div style="border:1px solid var(--border);border-radius:10px;padding:1rem;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3 vm-fields">
                                ...
                                <small style="color:var(--text-secondary);font-size:0.72rem;">extension@context voicemail.conf</small>
                            </div>
                            <div class="col-md-3 vm-fields">
                                ...
                                <small style="color:var(--text-secondary);font-size:0.72rem;">Fichier son Asterisk (sans extension)</small>
                            </div>
                            <div class="col-md-3 vm-fields">
                                ...
                                <small style="color:var(--text-secondary);font-size:0.72rem;">Classe MOH</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-check form-switch mt-1">
                        ...
                        <label class="form-check-label" style="font-size:0.82rem;">Enregistrer les appels</label>
                    </div>
                </div>
                <div class="col-md-3">
