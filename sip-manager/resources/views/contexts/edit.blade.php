...
@section('content')
    <div class="section-header">
        <div>
            <h5 class="mb-1" style="font-weight:700;">{{ __('ui.modify') }} « {{ $context->name }} »</h5>
            <p class="mb-0" style="font-size:0.82rem;color:var(--text-secondary);">{{ __('ui.edit_routing_rule') }}</p>
        </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="destination_type" class="form-select">
                        <option value="extensions" {{ old('destination_type', $context->destination_type) === 'extensions' ? 'selected' : '' }}>{{ __('ui.extensions') }}</option>
                        <option value="trunk" {{ old('destination_type', $context->destination_type) === 'trunk' ? 'selected' : '' }}>Trunk</option>
                        <option value="queue" {{ old('destination_type', $context->destination_type) === 'queue' ? 'selected' : '' }}>{{ __('ui.queue_dest') }}</option>
